...
def update_predictions(row):
    ...
    img_path = os.path.join(images_to_check_folder_2, img_file_name)
...
if __name__ == "__main__":
    ...
    file_path = os.path.join(current_directory, "web_image_collector")
    file_path_2 = os.path.join(file_path, "product_ref")
    ...
    images_to_check_folder_1 = os.path.join(current_directory, "web_image_collector")
    images_to_check_folder_2 = os.path.join(images_to_check_folder_1, "downloaded_images")
    ...
    results_df.to_excel("web_images_check.xlsx", index=False)
